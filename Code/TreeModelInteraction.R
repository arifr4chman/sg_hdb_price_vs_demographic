...
pred_valid <- predict(treemodel_storey, newdata = valid)
...
pred_valid <- predict(treemodel_location, newdata = valid)
RMSE(pred = pred_valid, obs = valid$price)
...
pred_valid <- predict(treemodel_sqm, newdata = valid)
RMSE(pred = pred_valid, obs = valid$price)
...
pred_valid <- predict(treemodel_lease, newdata = valid)
RMSE(pred = pred_valid, obs = valid$price)
